...
struct nomad_game_view_t : public nomad::game_view_t {
    ...
    virtual bool
    query_obj_rect_map(const nomad::rect_t &in,
    ...
    virtual bool
    query_obj_radius_map(const nomad::point_t &in, const float radius,
                         std::vector<const nomad::object_t *> &out) override {
        return false;
    }

    // get map tile information
    virtual bool get_map_info(const nomad::rect_t &in,
                              nomad::map_info_t &out) override {
        return false;
    }
...
nomad::game_t *create_game_nomad() { return new nomad_game_t; }
